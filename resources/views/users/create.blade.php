                ...
                <div class="card-body">
                    ...
                    <div class="form-group" data-select2-id="13">
                        ...
                        <select class="form-control select2 select2-hidden-accessible" id="system" name="system"
                            ...
                            <option value="2" @if (old('system') == '2') selected @endif> المحروقات
                            </option>
                            <option value="1"@if (old('system') == '1') selected @endif> الأرشيف
                            </option>
                        </select>
                    </div>
                    <div class="form-group userType" data-select2-id="13" style="display: none">
                        ...
                        <select class="form-control select2 select2-hidden-accessible" id="role" name="role"
                            ...
                            <option value="مدير"@if (old('role') == 'مدير') selected @endif> مدير
                            </option>
                            <option value="مستهلك"@if (old('role') == 'مستهلك') selected @endif id="opCons"> مستهلك
                            </option>
                        </select>
                    </div>
