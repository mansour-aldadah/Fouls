...
!(function (t, e) {
            ...
            return (
                ...
                (r._jQueryInterface = function (i) {
                    return this.each(function () {
                        ...
                        if (
                            (t || ((t = new r(this, e)), g(this).data(H, t)),
                            "number" == typeof i)
                        )
                            t.to(i);
    ...
    var ct,
        ...
        It = (function () {
            ...
            return (
                ...
                (t.show = function () {
                    ...
                    if (
                        ...
                        (this._parent &&
                            0 ===
                                (t = [].slice
                                    .call(this._parent.querySelectorAll(St))
                                    .filter(function (t) {
                                        return "string" ==
                        ...
                        !(
                            t &&
                            (e = g(t).not(this._selector).data(ut)) &&
                            e._isTransitioning
                        ))
                    ) {
                ...
                (t._getConfig = function (t) {
                    return (
                        ((t = l({}, gt, t)).toggle = Boolean(t.toggle)),
            ...
            return (
                ...
                (t._getPlacement = function () {
                    ...
                    return (
                        t.hasClass(Rt)
                            ? ((e = Vt.TOP),
                              g(this._menu).hasClass(Wt) && (e = Vt.TOPEND))
                            : t.hasClass(Ut)
                            ? (e = Vt.RIGHT)
                            : t.hasClass(Ft)
                            ? (e = Vt.LEFT)
                            : g(this._menu).hasClass(Wt) && (e = Vt.BOTTOMEND),
                        e
                    );
                }),
    ...
    g(document)
        .on(Lt.KEYDOWN_DATA_API, xt, Gt._dataApiKeydownHandler)
        .on(Lt.KEYDOWN_DATA_API, Kt, Gt._dataApiKeydownHandler)
        .on(Lt.CLICK_DATA_API + " " + Lt.KEYUP_DATA_API, Gt._clearMenus)
        .on(Lt.CLICK_DATA_API, xt, function (t) {
            t.preventDefault(),
                t.stopPropagation(),
        ...
        ge = (function () {
            ...
            return (
                ...
                (t._showElement = function (t) {
                    ...
                    var i = g.Event(ie.SHOWN, { relatedTarget: t }),
                        o = function () {
                ...
                (t._setEscapeEvent = function () {
                    ...
                    this._isShown && this._config.keyboard
                        ? g(this._element).on(ie.KEYDOWN_DISMISS, function (t) {
                              27 === t.which && (t.preventDefault(), e.hide());
                          })
                        : this._isShown ||
                          g(this._element).off(ie.KEYDOWN_DISMISS);
                }),
                (t._setResizeEvent = function () {
                    var e = this;
                    this._isShown
                        ? g(window).on(ie.RESIZE, function (t) {
                ...
                (o._jQueryInterface = function (n, i) {
                    return this.each(function () {
                        ...
                        if (
                            (t || ((t = new o(this, e)), g(this).data(Zt, t)),
                            "string" == typeof n)
                        ) {
                            if ("undefined" == typeof t[n])
                                throw new TypeError(
    ...
    var _e = "tooltip",
        ...
        Se =
            (((zt = { AUTO: "auto", TOP: "top" })[Te ? "LEFT" : "RIGHT"] =
                "right"),
            (zt.BOTTOM = "bottom"),
            ...
            return (
                ...
                (t._enter = function (t, e) {
                    ...
                    (e = e || g(t.currentTarget).data(n)) ||
                        ...
                        t &&
                            (e._activeTrigger["focusin" === t.type ? Le : Pe] =
                                !0),
                        g(e.getTipElement()).hasClass(Ne) ||
                        e._hoverState === Ie
                            ? (e._hoverState = Ie)
                ...
                (t._leave = function (t, e) {
                    ...
                    (e = e || g(t.currentTarget).data(n)) ||
                        ...
                        g(t.currentTarget).data(n, e)),
                        t &&
                            (e._activeTrigger["focusout" === t.type ? Le : Pe] =
                                !1),
                ...
                (t._handlePopperPlacementChange = function (t) {
                    ...
                    (this.tip = e.popper),
                        ...
                        this.addAttachmentClass(
                            this._getAttachment(Se[t.placement.toUpperCase()])
                        );
                }),
                ...
                (i._jQueryInterface = function (n) {
                    return this.each(function () {
                        ...
                        if (
                            ...
                            (t || ((t = new i(this, e)), g(this).data(me, t)),
                            "string" == typeof n)
                        ) {
                            if ("undefined" == typeof t[n])
                                throw new TypeError(
    ...
    var Ue = "popover",
        ...
        Qe = l({}, Re.DefaultType, { content: "(string|element|function)" }),
        Be = "fade",
        Ve = "show",
        Ye = ".popover-header",
        Xe = ".popover-body",
            ...
            return (
                ...
                (i._jQueryInterface = function (n) {
                    return this.each(function () {
                        ...
                        if (
                            (t || !/dispose|hide/.test(n)) &&
                            (t || ((t = new i(this, e)), g(this).data(Fe, t)),
                            "string" == typeof n)
                        ) {
                            if ("undefined" == typeof t[n])
                                throw new TypeError(
            ...
            return (
                ...
                (t._getConfig = function (t) {
                    if (
                        ...
                        e || ((e = _.getUID(Je)), g(t.target).attr("id", e)),
                            (t.target = "#" + e);
                    }
                ...
                (t._activate = function (e) {
                    ...
                    n.hasClass(rn)
                        ? (n.closest(fn).find(gn).addClass(sn), n.addClass(sn))
                        : (n.addClass(sn),
                          n
                              .parents(ln)
                              .prev(cn + ", " + un)
    ...
    g(window).on(on.LOAD_DATA_API, function () {
        for (
            var t = [].slice.call(document.querySelectorAll(an)), e = t.length;
            e--;
                    ...
                    if (
                        !(
                            (this._element.parentNode &&
                                this._element.parentNode.nodeType ===
                                    Node.ELEMENT_NODE &&
                                g(this._element).hasClass(Sn)) ||
                            g(this._element).hasClass(bn)
                        )
                    ) {
                        var t,
                            i,
                            e = g(this._element).closest(An)[0],
    ...
    var jn = "toast",
        ...
        Bn = { animation: !0, autohide: !0, delay: 500 },
            ...
            return (
                ...
                (t.hide = function (t) {
                    ...
                    this._element.classList.contains(qn) &&
                        (g(this._element).trigger(Wn.HIDE),
                        t
                            ? this._close()
